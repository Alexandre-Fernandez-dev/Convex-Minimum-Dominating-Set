...
\begin{tabular}{|*{3}{c|}}
    ...
    1000  & 1000 $\times$ 1000  & 50 \\
    \hline
    2000  & 2000 $\times$ 2000  & 78 \\
    \hline
    3000  & 3000 $\times$ 3000  & 106 \\
    \hline
    4000  & 4000 $\times$ 4000  & 133 \\
    \hline
    5000  & 5000 $\times$ 5000  & 161 \\
    \hline
    6000  & 6000 $\times$ 6000  & 189 \\
    \hline
\end{tabular}
\end{center}
...
Le but de la base 3 était d'obtenir des CDS plus grands que les bases 1 et 2, pour cela on voulait fixer le seuil, les tests étant trop long a générer le seuil a été fixé à
$$
seuil = nbpoints \times \frac{1}{36} + \frac{200}{9}
$$
